...
light, it makes sense that the linear function can be priced accurately
(because it has the lowest average value), and that the logistic function can be
priced accurately as well (because it changes gradually). On the other hand, the
...
% TODO: is a future work section in order?
